...
namespace SunriseCalculator
{
    public class SolarInfo
    {
        ...
        private static DateTime calcDayFromJD(double jd)
        {
            ...
            return new DateTime((int)year, (int)month, (int)day, 0, 0, 0);
        }
        ...
        private static bool isNumber(double inputVal)
        {
            ...
            return !DoubleEx.IsNaN(inputVal);
        }
        ...
        private static double calcSunEqOfCenter(double t)
        {
            ...
            var mrad = degToRad(m);
            var sinm = MathEx.Sin(mrad);
            var sin2m = MathEx.Sin(mrad + mrad);
            var sin3m = MathEx.Sin(mrad + mrad + mrad);
        ...
        private static double calcSunRadVector(double t)
        {
            ...
            var R = (1.000001018 * (1 - e * e)) / (1 + e * MathEx.Cos(degToRad(v)));
            return R;	// in AUs
        }
        ...
        private static double calcSunApparentLong(double t)
        {
            ...
            var lambda = o - 0.00569 - 0.00478 * MathEx.Sin(degToRad(omega));
        ...
        private static double calcObliquityCorrection(double t)
        {
            ...
            var omega = 125.04 - 1934.136 * t;
            var e = e0 + 0.00256 * MathEx.Cos(degToRad(omega));
            return e;	// in degrees
        }
        ...
        private static double calcSunRtAscension(double t)
        {
            ...
            var tananum = (MathEx.Cos(degToRad(e)) * MathEx.Sin(degToRad(lambda)));
            var tanadenom = (MathEx.Cos(degToRad(lambda)));
            var alpha = radToDeg(MathEx.Atan2(tananum, tanadenom));
        ...
        private static double calcSunDeclination(double t)
        {
            ...
            var sint = MathEx.Sin(degToRad(e)) * MathEx.Sin(degToRad(lambda));
            var theta = radToDeg(MathEx.Asin(sint));
        ...
        private static double calcEquationOfTime(double t)
        {
            ...
            var y = MathEx.Tan(degToRad(epsilon) / 2.0);
            y *= y;

            var sin2l0 = MathEx.Sin(2.0 * degToRad(l0));
            var sinm = MathEx.Sin(degToRad(m));
            var cos2l0 = MathEx.Cos(2.0 * degToRad(l0));
            var sin4l0 = MathEx.Sin(4.0 * degToRad(l0));
            var sin2m = MathEx.Sin(2.0 * degToRad(m));
        ...
        private static double calcHourAngleSunrise(double lat, double solarDec)
        {
            ...
            var HAarg = (MathEx.Cos(degToRad(90.833)) / (MathEx.Cos(latRad) * MathEx.Cos(sdRad)) - MathEx.Tan(latRad) * MathEx.Tan(sdRad));
            var HA = (MathEx.Acos(MathEx.Cos(degToRad(90.833)) / (MathEx.Cos(latRad) * MathEx.Cos(sdRad)) - MathEx.Tan(latRad) * MathEx.Tan(sdRad)));
